...
var Jx3Simulator = function () {
	...
	_createClass(Jx3Simulator, [{
		...
		key: 'oneSimulation',
		value: function oneSimulation() {
			var options = this.options;
			var period = options.duration * 16;
			return new Promise(function (resolve, reject) {
				setTimeout(function () {
					...
					var t1 = present();
					var dps = ctrl.damage / options.duration;
					dps = dps.toFixed(0);
					var info = {
						dps: dps,
						performance: t1 - t0,
		...
		key: 'multipleSimulation',
		value: function multipleSimulation() {
			var workers = workerFarm(require.resolve('./libs/task'));
			var ret = 0;
			var options = this.options;
			var results = [];
			return new Promise(function (resolve, reject) {
				...
				function resultCollector(err, result) {
					...
					if (++ret == options.iterator) {
						...
						var dps = Math.floor(results.reduce(function (a, b) {
							return a + b;
						}) / ret);
						var t1 = present();
						var info = {
				...
				for (var i = 0; i < options.iterator; i++) {
...
},{"./libs/Controller":3,"present":17,"worker-farm":22}],2:[function(require,module,exports){
'use strict';
...
var Buff = function () {
	...
	_createClass(Buff, [{
		...
		value: function calc(ctrl, multiHit) {
			...
			var attack = parseInt(ctrl.myself.attributes.basicAttack, 10) + ctrl.myself.attributes.spunk * 1.95 * ( // TODO: 支持多心法最受益属性
			1 + this.extraAttr.attackAddPercent / 100 + ctrl.myself.extra.attackAddPercent / 100) + this.extraAttr.attackAddBase + ctrl.myself.extra.attackAddBase;
			...
			var log = this.name + '(buff) ' + status + ' ' + damage;
...
var Controller = function () {
		...
		value: function addBuff(buff) {
			...
			if (!(buff.name in this.buffCtrl.selfList)) {
				...
				if (buff.type == 'buff') {
					...
					try {
						for (var _iterator4 = Object.keys(buff.data)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
				...
				if (buff.type == 'buff' && existBuff.level < level) {
					...
					try {
						for (var _iterator5 = Object.keys(buff.data)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
							var _key = _step5.value;

							var _buffNumber = buff.data[_key];
							this.myself.extra[_key] += _buffNumber;
						}
					} catch (err) {
		...
		value: function addDebuff(buff) {
			...
			if (!(buff.name in this.buffCtrl.targetList)) {
				...
				if (buff.type == 'buff') {
					...
					try {
						for (var _iterator6 = Object.keys(buff.data)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
				...
				if (buff.type == 'buff' && existBuff.level < level) {
					...
					try {
						for (var _iterator7 = Object.keys(buff.data)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
							var _key2 = _step7.value;

							var _buffNumber2 = buff.data[_key2];
							this.myself.extra[_key2] += _buffNumber2;
						}
					} catch (err) {
		...
		value: function deleteBuff(buffName) {
			if (buffName in this.buffCtrl.selfList) {
				...
				if (buff.type == 'buff') {
					...
					try {
						for (var _iterator8 = Object.keys(buff.data)[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
		...
		value: function deleteDebuff(buffName) {
			if (buffName in this.buffCtrl.targetList) {
				...
				if (buff.type == 'buff') {
					...
					try {
						for (var _iterator9 = Object.keys(buff.data)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
   ...
   */
		...
		value: function dotRefresh(buffName) {
			if (buffName in this.buffCtrl.targetList) {
				...
				var selfHaste = this.myself.attributes.haste;
				var extraHaste = this.myself.extra.haste;
				buff.remain = (buff.duration / buff.interval - 1) * Utils.hasteCalc(selfHaste, extraHaste, buff.interval) + Utils.hasteCalc(selfHaste, extraHaste, refreshTime);
				...
				if (buff.recipeName != 'none') {
					...
					try {
						for (var _iterator10 = this.recipes[buff.recipeName][Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
							var recipe = _step10.value;
   ...
   */
		...
		value: function cdCtrl() {
			...
			try {
				for (var _iterator11 = Object.keys(this.skillCtrl.list)[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
					var skillKey = _step11.value;
		...
		value: function buffTimeCtrl() {
			...
			try {
				for (var _iterator12 = Object.keys(this.buffCtrl.selfList)[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
					var buffKey = _step12.value;
			...
			try {
				for (var _iterator13 = Object.keys(this.buffCtrl.targetList)[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
					var _buffKey = _step13.value;
		...
		value: function extraAttributeApply() {
			...
			try {
				for (var _iterator14 = Object.keys(this.buffCtrl.selfList)[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
					var buffKey = _step14.value;
					...
					if (buff.type == 'buff') {
						...
						try {
							for (var _iterator16 = Object.keys(buff.data)[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
			...
			try {
				for (var _iterator15 = Object.keys(this.buffCtrl.targetList)[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
					var _buffKey2 = _step15.value;
					...
					if (_buff2.type == 'buff') {
						...
						try {
							for (var _iterator17 = Object.keys(_buff2.data)[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
								var _key3 = _step17.value;

								var _buffNumber3 = _buff2.data[_key3];
								this.myself.extra[_key3] += _buffNumber3 * _buff2.level;
							}
						} catch (err) {
...
},{"./Utils":6,"lodash":15}],5:[function(require,module,exports){
'use strict';
...
},{"prr":19}],14:[function(require,module,exports){
...
},{"./fork":21,"_process":18,"errno":14,"os":16,"xtend":23}],21:[function(require,module,exports){
(function (process){
...
},{"_process":18,"child_process":12}],22:[function(require,module,exports){
(function (process){
...
},{"./farm":20,"_process":18}],23:[function(require,module,exports){
